...
# Example usage
source_directory = r'C:\STM32\stm32ai-modelzoo\image_classification\scripts\training\datasets\data_model_1'  # Replace with your source directory path
destination_directory = r'C:\STM32\stm32ai-modelzoo\image_classification\scripts\training\datasets\test'  # Replace with your destination directory path
